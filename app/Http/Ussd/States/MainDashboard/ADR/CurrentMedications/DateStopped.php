...
class DateStopped extends State
{
    protected function beforeRendering(): void
    {
        $this->menu->line('Enter valid current medication date stopped '.$this->record->get('medicationCount').' format ddmmyyyy eg 01012022');
    }
    ...
    protected function afterRendering(string $argument): void
    {
        ...
        $this->record->set('dateStopped'.$currentCount, $formattedDate);
        $this->decision->any(SuspectedMedication::class);
    }
}
