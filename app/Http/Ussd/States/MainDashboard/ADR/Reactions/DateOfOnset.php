...
class DateOfOnset extends State
{
    protected function beforeRendering(): void
    {
        $this->menu->line('Enter valid adverse reaction date of onset format ddmmyyyy eg 01012022');
    }
    ...
    protected function afterRendering(string $argument): void
    {
        ...
        $this->record->set('dateOfOnset', $formattedDate);
        $this->decision->any(Duration::class);
    }
}
