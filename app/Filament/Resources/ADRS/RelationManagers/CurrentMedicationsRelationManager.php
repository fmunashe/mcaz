...
use App\Filament\Exports\CurrentMedicationExporter;
...
class CurrentMedicationsRelationManager extends RelationManager
{
    protected static string $relationship = 'currentMedications';
        ...
        return $schema
            ->components([
                ...
                DatePicker::make('date_stopped')
                    ->required(),
                TextInput::make('medication_administration_method')
                    ->required(),
        ...
        return $schema
            ...
            ->components([
                ...
                TextEntry::make('frequency')
                    ->placeholder('-'),
                TextEntry::make('medication_administration_method')
                    ->placeholder('-'),
        ...
        return $table
            ...
            ->columns([
                ...
                TextColumn::make('suspected_medicine')
                    ->badge()
                    ->toggleable(),
                TextColumn::make('medication_administration_method')
                    ->badge()
                    ->toggleable()
                    ->sortable(),
            ...
            ->headerActions([
                CreateAction::make(),
                ExportAction::make()
                    ->exporter(CurrentMedicationExporter::class)
